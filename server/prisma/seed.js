...
async function main() {
    ...
    // Create dealer
    const dealerPassword = await bcryptjs_1.default.hash('dealer123', 12);
    ...
    const products = [
        {
            ...
            category: client_1.ProductCategory.SCREEN,
            priceUsd: 68.00,
            stock: 45,
            criticalLimit: 5,
        ...
        },
        {
            ...
            category: client_1.ProductCategory.BATTERY,
            priceUsd: 35.50,
            stock: 3,
            criticalLimit: 5,
        ...
        },
        {
            ...
            category: client_1.ProductCategory.KEYBOARD,
            priceUsd: 18.25,
            stock: 120,
            criticalLimit: 10,
            dealerDiscountPercent: 10,
        ...
        },
        {
            ...
            category: client_1.ProductCategory.CHIPSET,
            priceUsd: 145.00,
            stock: 8,
            criticalLimit: 2,
        ...
        },
        {
            ...
            category: client_1.ProductCategory.RAM,
            priceUsd: 22.00,
            stock: 150,
            criticalLimit: 15,
        ...
        },
        {
            ...
            category: client_1.ProductCategory.STORAGE,
            priceUsd: 42.00,
            stock: 200,
            criticalLimit: 20,
            dealerDiscountPercent: 8,
        ...
        },
        {
            ...
            category: client_1.ProductCategory.MOTHERBOARD,
            priceUsd: 185.00,
            stock: 6,
            criticalLimit: 2,
            dealerDiscountPercent: 5,
